...
export default function Create_Account() {
    ...
    return(
        <>
            <div className="flex flex-col items-center justify-center h-screen w-screen bg-[url('./assets/swim_bg2.png')] bg-cover">
                <div className="flex flex-col items-center justify-center bg-white rounded rounded-lg w-1/4 py-4">
                    <h3 className="text-2xl font-semibold p-4">Create New Account</h3>
                    <form
                        onSubmit={onSubmit}
                        className="flex flex-col items-center justify-center w-3/4"
                    >
                        <div className="w-full">
                            <label htmlFor="email" className="flex justify-start w-full p-2 text-lg">
                                Email
                            </label>
                        </div>
                        ...
                        <div className="w-full">
                            <label htmlFor="user" className="flex justify-start w-full p-2 text-lg">
                                Username
                            </label>
                        </div>
                        <div className="pb-5 w-full">
                        ...
                        <div className="w-full">
                            <label htmlFor="pass" className="flex justify-start w-full p-2 text-lg">
                                Password
                            </label>
                        </div>
                        <div className="pb-5 w-full">
